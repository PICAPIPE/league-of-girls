angular.module('communications').controller('CommunicationsCreateCtrl',[
     '$scope',
     '$rootScope',
     '$state',
     '$window',
     ...
     function($scope, $rootScope, $state, $window, $controller, store) {
          ...
          ctrl.submit = function()
          {
              ...
              ctrl.DB.call('Communications',method, params, ctrl.fieldData).then(
                function(result)
                {
                    var fn = null;
                ...
                function(errorResult)
                {
                    ...
                    ctrl.ALERT.add({
                        'title':     ctrl.LANG.getString('Fehler beim Speichern der Kommunikationsmethode aufgeteten.'),
                        'message':   message,
                        'autoClose': true
                    });
                }
            ...
            ctrl.fields = [
              ...
              },
              {
                 ...
                 "templateOptions":
                 {
                     ...
                     "placeholder":     ctrl.LANG.getString('Geben Sie die CSS-Klasse für das Icon ein, welches für die Kommunikationsmethode verwendet werden soll.')
                 }
              },
              {
                "type": "input",
          ...
          ctrl.$onInit = function()
          {
                ...
                if (angular.isDefined(ctrl.uuid) === true)
                      {
                      ctrl.DB.call('Communications','show',ctrl.uuid).then(
                          function(result){
                          ...
                          function(errorResult)
                          {
                              ...
                              ctrl.ALERT.add({
                                  'title':     ctrl.LANG.getString('Fehler beim Öffnen der Kommunikationsmethode aufgetreten.'),
                                  'message':   message,
                                  'autoClose': true
                              });
                          }
